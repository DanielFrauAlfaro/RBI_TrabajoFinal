...
def main(config):
    ...
    # Se crea un modelo con la configuración deseada. Ver "src/model_handler.py"
    model = ModelHandler(config)

    # Entrena el modelo para obtener y mostrar las métricas
...
if __name__ == '__main__':
    ...
    # Según el campo 'config' ejecuta el entrenamiento con 'multi_run' o 'run'
    #   En este trabajo se va a centrar en la función 'main' con 'run' normal, que es como está la 
